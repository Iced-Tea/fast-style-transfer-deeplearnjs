...
function preprocessInput(gpgpu, preprocessInputShader, sourceTex, resultTex, shapeRowCol) {
    ...
    var samplerLocation = deeplearn_1.webgl_util.getProgramUniformLocationOrThrow(gpgpu.gl, preprocessInputShader, 'source');
...
},{"deeplearn":39}],77:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var deeplearn_1 = require("deeplearn");
...
var TransformNet = (function () {
    function TransformNet(gpgpu, math, style) {
        this.gpgpu = gpgpu;
        this.math = math;
        this.style = style;
    }
    ...
    TransformNet.prototype.preprocessColorTextureToArray3D = function (rgbTexture, imageDimensions) {
        var preprocessInputShader = imagenet_util.getUnpackAndPreprocessInputShader(this.gpgpu, [imageDimensions[0], imageDimensions[1]]);
        var preprocessResultShapeRC = [imageDimensions[0], imageDimensions[1] * 3];
        var preprocessResultTexture = this.math.getTextureManager().acquireTexture(preprocessResultShapeRC);
        imagenet_util.preprocessInput(this.gpgpu, preprocessInputShader, rgbTexture, preprocessResultTexture, preprocessResultShapeRC);
        return deeplearn_1.NDArray.make([imageDimensions[0], imageDimensions[1], 3], {
    ...
    TransformNet.prototype.instanceNorm = function (input, varId) {
        ...
        var _b = this.instanceMoments(input), mu = _b[0], sigma_sq = _b[1];
        ...
        var normalized = this.math.divideStrict(this.math.subStrict(input, mu), this.math.sqrt(this.math.add(sigma_sq, epsilon)));
    ...
    TransformNet.prototype.instanceMoments = function (input) {
        var _a = input.shape, height = _a[0], width = _a[1], inDepth = _a[2];
        var hWProduct = height * width;
        var mathCPU = new deeplearn_1.NDArrayMathCPU;
        console.log('instanceMoments: switching dims');
        var switched = mathCPU.switchDim(input, [2, 0, 1]);
        console.log('instanceMoments: switched dims');
        var switchedValues = switched.getValues();
        var means = [];
        var variances = [];
        for (var i = 0; i < inDepth; i++) {
            var curr = switchedValues.slice(i * hWProduct, (i + 1) * hWProduct);
            var sum = 0;
        ...
        var keepDimMeans = new Array(hWProduct * inDepth);
        var keepDimVariances = new Array(hWProduct * inDepth);
        for (var i = 0; i < hWProduct; i++) {
            for (var j = 0; j < inDepth; j++) {
        ...
        var meansArray = deeplearn_1.Array3D.new(input.shape, keepDimMeans);
        var variancesArray = deeplearn_1.Array3D.new(input.shape, keepDimVariances);
...
},{"./imagenet_util":76,"deeplearn":39}],78:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var StyleTransferDemo = (function (_super) {
    ...
    StyleTransferDemo.prototype.ready = function () {
        ...
        this.startButton.addEventListener('click', function () {
            ...
            _this.transformNet = new net_1.TransformNet(_this.gpgpu, _this.math, STYLE_MAPPINGS[_this.selectedStyleName]);
    ...
    StyleTransferDemo.prototype.runInference = function () {
        ...
        this.math.scope(function (keep, track) {
            var canvasTexture = _this.math.getTextureManager().acquireTexture(canvasTextureShape);
            _this.gpgpu.uploadPixelDataToTexture(canvasTexture, _this.contentImgElement);
            console.log(canvasTexture);
            var preprocessed = _this.transformNet.preprocessColorTextureToArray3D(canvasTexture, canvasTextureShape);
...
},{"./net":77,"./polymer-spec":78,"deeplearn":39}]},{},[79]);
